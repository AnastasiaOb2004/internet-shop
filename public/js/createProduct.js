const createProduct = (data) => {
    ...
    ${data.draft ? `<span class="tag">Draft</span>` : ''}
     ...
     <button class="card-action-btn edit-btn" onclick="location.href='/addProduct/${data.id}'"><img src="images/edit.png" alt=""></button>
     <button class="card-action-btn open-btn" onclick="location.href='/product/${data.id}'"><img src="images/open.png" alt=""></button>
    ...
    <div class="product-info">
        ...
        <span class ="price">${data.sellingPrice}</span><span class="actual-price">${data.actualPrice}</span>
    </div>
    </div>`
}
 const openDeletePopup = (id) =>{
    ...
    let deleteBtn = document.querySelector('.delete-btn-popup');
    ...
    fetch('/delete-product', {
       ...
       .then(data => {
        if(data == 'success'){
            ...
            showAlert('some error has occured while deleting the product');
        }
       }) 
}
